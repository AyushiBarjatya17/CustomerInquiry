...
struct iPhoneThemeSettingsView: View {
...
struct iPhoneThemeOptionCard: View {
    let theme: AppTheme
    let isSelected: Bool
    let onTap: () -> Void
...
#Preview {
    iPhoneThemeSettingsView(themeManager: ThemeManager.shared)
